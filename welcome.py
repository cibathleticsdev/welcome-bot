...
async def on_member_join(member):
    ...
    await client.send_message(member, 'Welcome to this server, ' + member.mention + '! I\'m Welcome Bot, a CAD bot and assistant of Archie, the official CADevelopers discord bot. Nice to meet you! Please, read our #rules and #about in our discord server https://discord.gg/TS583KK to be updated. To see Archie\'s list of commands type !help. Have fun and RESPECT!! :grinning: :desktop:')
